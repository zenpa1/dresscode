...
class OutfitCreationDialog extends StatefulWidget {
  const OutfitCreationDialog({super.key});

  @override
  State<OutfitCreationDialog> createState() => _OutfitCreationDialogState();
}

class _OutfitCreationDialogState extends State<OutfitCreationDialog> {
